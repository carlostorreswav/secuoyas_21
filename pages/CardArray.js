...
const Texts = {
  ...
  c03: "Secuoyas ha tenido 4 CEOs, y 3 de ellos siguen en la compañía.",
  c04: "Tenemos pasados muy heterogéneos: pastelera creativa, portero, militar, concursante de Masterchef, compositor musical, ingeniero de un equipo de Rallyes, periodista… Un background muy amplio que nos convierte en un equipo multidisciplinar.",
  ...
  c08: "Nuestros procesos de recruiting y onboarding los diseñó el equipo en 2015. Y es que la llegada de Daniel Serrano marcó un antes y un después en la compañía.",
  c09: "Los equipos asignados a un proyecto, sólo trabajan para ese cliente.",
  ...
  c14: "Todos los viernes el algoritmo decide con qué compañeros tomamos un café, la mejor manera de conocer a todo el equipo aunque estemos en remoto.",
  c15: "Antes de incorporar a una persona a Secuoyas se consulta con el equipo por si alguien tiene algo en contra. Como en las bodas.",
  c16: "Desde que somos full remote 14 personas han cambiado de ciudad… y de vida. Algunos de manera temporal, durante los meses de verano, otros de manera permanente, llegando incluso a traspasar fronteras.",
  c17: "En 2020 éramos 26 personas en Secuoyas, hoy somos 56. En dos años el equipo se ha multiplicado, especialmente el área de desarrollo, en la cual empezaron siendo 3 developers y hoy la cifra asciende a 19.",
  c18: "Cada mañana nos damos los buenos días cuando nos conectamos. Las buenas maneras se cuidan también en remoto.",
  c19: "Además de los proyectos con cliente, desarrollamos proyectos propios. Griddo es el más importante de ellos, y en él trabajan permanentemente 12 del equipo.",
